...
public class UtilsBot {
    ...
    /**
     * @param textoMensagem
     *   Perguntando qual o genero desejado, caso ja tenha informado, chama funcao sendFilmes
     * @return
     */
    ...
    /**
     * @param genero
     * Retorna lista de filmes de acordo com genero passado por parametro
     * @return
     */
    ...
    static SendMessage responseBot(Update update) {
        ...
        Matcher ola = Pattern.compile("\\b(?:ola|oi|start)\\b").matcher(textoMensagem);
